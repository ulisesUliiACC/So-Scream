  ...
  return function () {
            ...
            return function () {
                  ...
                  3331: function _(e, t, n) {
                    ...
                    if (o) {
                      if (!s(function () {
                        ...
                        for (var H, Y = (_C2 = function C(e) {
                            return l(this, _C2), new T(p(e));
                          })[S] = T[S], G = y(T), Q = 0; G.length > Q;) (H = G[Q++]) in _C2 || a(_C2, H, T[H]);
                        Y.constructor = _C2;
                      }
                      v && d(R) !== I && v(R, I);
                      var $ = new _L(new _C2(2)),
                        V = R.setInt8;
                      $.setInt8(0, 2147483648), $.setInt8(1, 2147483649), !$.getInt8(0) && $.getInt8(1) || u(R, {
                    ...
                    }, i && (B(_C2, "byteLength"), B(_L, "buffer"), B(_L, "byteLength"), B(_L, "byteOffset")), u(_L[S], {
                    ...
                    var r,
                      ...
                      _y = function y() {
                        ...
                        _y = r ? function (e) {
                          ...
                          return e = null, t;
                        }(r) : (t = l("iframe"), n = "java" + p + ":", t.style.display = "none", s.appendChild(t), t.src = String(n), (e = t.contentWindow.document).open(), e.write(v("document.F=Object")), e.close(), e.F);
                        for (var i = a.length; i--;) delete _y[f][a[i]];
                        return _y();
                      };
                    u[h] = !0, e.exports = Object.create || function (e, t) {
                      var n;
                      return null !== e ? (d[f] = i(e), n = new d(), d[f] = null, n[h] = e) : n = _y(), void 0 === t ? n : o(n, t);
                    };
                  },
                  ...
                  561: function _(e, t, n) {
                    ...
                    r({
                      ...
                      splice: function splice(e, t) {
                        ...
                        if (c.length = r, n < r) {
                          for (h = m; h < g - r; h++) v = h + n, (d = h + r) in y ? y[v] = y[d] : delete y[v];
                          for (h = g; h > g - r + n; h--) delete y[h - 1];
                        } else if (n > r) for (h = g - r; h > m; h--) v = h + n - 1, (d = h + r - 1) in y ? y[v] = y[d] : delete y[v];
              ...
              return function () {
                    ...
                    value: function value(t) {
                      ...
                      if (n) {
                        var a,
                          u = e(n, !0);
                        try {
                          for (u.s(); !(a = u.n()).done;) a.value.apply(this, i);
                        } catch (e) {
                          u.e(e);
                        } finally {
                          u.f();
                ...
                var x = function (e) {
                  ...
                  function n(e, r) {
                    var i, o, a;
                    if (p(this, n), (i = t.call(this)).element = e, i.version = n.version, i.clickableElements = [], i.listeners = [], i.files = [], "string" == typeof i.element && (i.element = document.querySelector(i.element)), !i.element || null == i.element.nodeType) throw new Error("Invalid dropzone element.");
                    if (i.element.dropzone) throw new Error("Dropzone already attached.");
                    n.instances.push(m(i)), i.element.dropzone = m(i);
                    var u = null != (a = n.optionsForElement(i.element)) ? a : {};
                    if (i.options = n.extend({}, s, u, null != r ? r : {}), i.options.previewTemplate = i.options.previewTemplate.replace(/\n*/g, ""), i.options.forceFallback || !n.isBrowserSupported()) return g(i, i.options.fallback.call(m(i)));
                  ...
                  return d(n, [{
                    ...
                    value: function value(e, t) {
                      var n = this,
                        r = e.createReader(),
                        i = function i(e) {
                          return t = console, n = "log", r = function r(t) {
                            return t.log(e);
                    ...
                    key: "resizeImage",
                    value: function value(e, t, r, i, o) {
                      var a = this;
                      return this.createThumbnail(e, t, r, i, !0, function (t, r) {
                        ...
                        return "image/jpeg" !== i && "image/jpg" !== i || (u = A.restore(e.dataURL, u)), o(n.dataURItoBlob(u));
                      });
                    }
                  }, {
                    key: "createThumbnail",
                    ...
                    value: function value(e, t, n, r) {
                      ...
                      this.emit("addedfile", e), this.emit("complete", e), o ? (e.dataURL = t, this.createThumbnailFromUrl(e, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.thumbnailMethod, this.options.fixOrientation, function (t) {
                    ...
                    value: function value(e, t) {
                      var r,
                        ...
                        a = c(e, !0);
                      try {
                        for (a.s(); !(r = a.n()).done;) r.value.xhr = o;
                      } catch (e) {
                        a.e(e);
                      } finally {
                        a.f();
                ...
                x.initClass(), x.version = "5.9.3", x.options = {}, x.optionsForElement = function (e) {
                ...
                var k = function k(e, t, n, r, i, o, a, u, s, l) {
                    var c = function (e) {
                      e.naturalWidth;
                ...
                A.initClass(), x._autoDiscoverFunction = function () {
    ...
    return function () {
      ...
      t().autoDiscover = !1, t().prototype.uploadFiles = function (e) {
        for (var n = this, r = 0; r < e.length; r++) for (var i = e[r], o = Math.round(Math.min(60, Math.max(6, i.size / 1e5))), a = 0; a < o; a++) {
          var u = 100 * (a + 1);
          setTimeout(function (e, r, i) {
            return function () {
              ...
              }, n.emit("uploadprogress", e, e.upload.progress, e.upload.bytesSent), 100 === e.upload.progress && (e.status = t().SUCCESS, n.emit("success", e, "success", null), n.emit("complete", e), n.processQueue());
            };
          }(i, o, a), u);
        }
      };
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/assets/vendor/libs/dropzone/dropzone.js");
