			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="breadcrumb-text">
						<p>Apasionados por crear alimentos biotecnológicos</p>
						<h1>IMBA</h1>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="featured-text">
						<h2 class="pb-3">Grupo <span class="orange-text">IMBA</span></h2>
						<div class="row">
							...
							<div class="col-lg-6 col-md-6">
								<div class="list-box d-flex">
									...
									<div class="content">
										<h3>Filosofia</h3>
										<p>Fusionar calidad, innovación y pasión en cada bocado.</p>
									</div>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2 text-center">
					<div class="section-title">
						<h3>Nuestro <span class="orange-text">equipo de trabajo</span></h3>
						<p>Nosotros somos IMBA.</p>
					</div>
				</div>
			</div>
			<div class="row">
