...
@section('content')
    ...
    <head>
        ...
        <title>Card Centered</title>
        <!-- Agrega aquí los enlaces a las hojas de estilo de Bootstrap y otros recursos -->
        ...
        <div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh;">
            <div class="card">
                <form class="form_container" method="POST" action="{{ route('register') }}">
                  @csrf
                <div class="logo_container" href="assets/img/favicon.png"></div>
                <div class="title_container">
                  <p class="title">Cree  una nueva cuenta</p>
                  <span class="subtitle">Comience con nuestra aplicación, simplemente cree una cuenta y disfrute de la experiencia.</span>
                </div>
                <br>
                <div class="input_container">
                  <label class="input_label">Nombre</label>
                  <input  title="Inpit title" name="name" type="text" class="input_field">
                </div>

                <div class="input_container">
                  <label class="input_label">Apellido Paterno</label>
                  <input  title="Inpit title" name="apellido_P" type="text" class="input_field">
                </div>

                <div class="input_container">
                  <label class="input_label">Apellido Materno</label>
                  <input  title="Inpit title" name="apellido_M" type="text" class="input_field">
                </div>
