                                                ...
                                                <form action="index.html">
                                                    ...
                                                    <p>
                                                        ...
                                                        <input type="tel" id="codigo-postal"
                                                            placeholder="Código Postal" pattern="[0-9]{5}" required>
                                                        <span class="error" id="codigo-postal-error"></span>
                                                    </p>
                                                    <p>
                                                        <textarea name="bill" id="bill" cols="30" rows="10"placeholder="referencias"></textarea>
                                                    </p>
